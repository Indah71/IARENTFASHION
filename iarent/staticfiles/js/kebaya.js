...
class KebayaApp {
    ...
    init() {
        ...
        this.loadWishlist();
        this.loadCart();
        console.log('Kebaya App initialized');
    }
                    ...
                    <div class="cart-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-end">
                                <button class="remove-item" onclick="kebayaApp.removeFromCartServer(${item.id})" title="Hapus dari keranjang">
                    ...
                    wishlistHTML += `
                        <div class="d-flex justify-content-between align-items-center mb-2 p-2 border-bottom">
                            ...
                            <div class="text-end">
                                ...
                                <button class="btn btn-sm btn-outline-danger ms-2" onclick="kebayaApp.removeFromWishlist(${item.id})">
                    ...
                    cartHTML += `
                        <div class="d-flex justify-content-between align-items-center mb-2 p-2 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mt-1">
                                        <button class="btn btn-sm btn-outline-secondary p-0" style="width: 20px; height: 20px;" onclick="kebayaApp.updateCartQuantity(${item.id}, -1)">-</button>
                            ...
                            <div class="text-end">
                                ...
                                <button class="btn btn-sm btn-outline-danger ms-2" onclick="kebayaApp.removeFromCartLocal(${item.id})">
                                    <i class="bi bi-trash"></i>
                                </button>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    window.kebayaApp = new KebayaApp();
});

// Global functions untuk HTML onclick attributes
function goToDetail(productId) {
    window.kebayaApp.goToDetail(productId);
}

function addToCart(productId) {
    window.kebayaApp.addToCart(productId);
}

function addToWishlist(productId) {
    window.kebayaApp.addToWishlist(productId);
}

function addToWishlistLocal(productId) {
    window.kebayaApp.addToWishlistLocal(productId);
}

function addToCartLocal(productId) {
    window.kebayaApp.addToCartLocal(productId);
}

function continueShopping() {
    window.kebayaApp.continueShopping();
}

function checkout() {
    window.kebayaApp.checkout();
}

function handleSewaClick() {
    window.kebayaApp.handleSewaClick();
}

function showCart() {
    window.kebayaApp.showCart();
}

function removeFromCart(productId) {
    window.kebayaApp.removeFromCartLocal(productId);
}